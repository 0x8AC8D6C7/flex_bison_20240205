...
#line 13 "./src/demo.y"
                    { printf("= %d\n", yyvsp[-1]); }
#line 1072 "./build/demo.tab.c"
    break;

  case 5: /* exp: exp ADD factor  */
#line 17 "./src/demo.y"
                  { yyval = yyvsp[-2] + yyvsp[0];}
#line 1078 "./build/demo.tab.c"
    break;

  case 6: /* exp: exp SUB factor  */
#line 18 "./src/demo.y"
                  { yyval = yyvsp[-2] - yyvsp[0];}
#line 1084 "./build/demo.tab.c"
    break;

  case 8: /* factor: factor MUL term  */
#line 22 "./src/demo.y"
                   { yyval = yyvsp[-2] * yyvsp[0]; }
#line 1090 "./build/demo.tab.c"
    break;

  case 9: /* factor: factor DIV term  */
#line 23 "./src/demo.y"
                   { yyval = yyvsp[-2] / yyvsp[0]; }
#line 1096 "./build/demo.tab.c"
    break;

  case 11: /* term: ABS term  */
#line 27 "./src/demo.y"
            { yyval = yyvsp[0] >= 0 ? yyvsp[0] : -yyvsp[0]; }
#line 1102 "./build/demo.tab.c"
    break;


#line 1106 "./build/demo.tab.c"
